var path = "../services/curl.php"
//path is ../../ on sitebuilt.net
var state = "OFF";
var til = 15;
var relay = 0;
$('#main-page').live('pageinit', function(event) {
    $(".button-boost").click(function() {
        ...
        $.get(path, { status: state, relay: "0",til: til } );
    });
    $("#ctr-timed").click(function(){
        ...
        $.get(path, { status: state, relay: relay, til: til } );        
    })    
    ...
    $("#ctr-on").click(function(){
        ...
        $.get(path, { status: state, relay: relay} );        
    })     
